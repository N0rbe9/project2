...
class HumanPlayer(Player):
    def get_move(self,game):
        ...
        while not valid_square:
            ...
            #skotrolujeme ci je to spravan hodnota a to tym ze to budeme pisat
            #ako integer. A ked to neni spravna hodnota tak vypiseme ze je to  invalid input
            #ked ten spot tiez neni prisupny lebo je opsadeni tiez vypisime ze je invalid input
            try:
                val = int(square)
...
class GeniusComputerPlayer(Player):
    def get_move(self,game):
        if len(game.available_moves()) == 9:
            ...
            square = self.minimax(game,self.letter)["position"] # position je vlastne chces ist "O"
        return square
    ...
    def minimax(self, state,player):
        ...
        #first, we wanna check if the previous move is a winner
